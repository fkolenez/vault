...
Use uma seção por conflito. Inclua alegações, fontes, impacto, estado e resolução — sem apagar posições históricas.
...
### Sockets como abstração de placas

Resolvida na página [[wiki/temas/Sistemas operacionais|Sistemas operacionais]]: sockets abstraem comunicação; dispositivos são expostos por drivers e interfaces próprias.

### T568B como cabo crossover

Resolvida na página [[wiki/temas/Redes|Redes]]: crossover combina T568A em uma ponta e T568B na outra.
