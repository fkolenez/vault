# Mapa de conexões do vault

Este arquivo reúne os principais pontos de ligação entre os temas do repositório e ajuda a navegar entre os conceitos de forma mais natural.
...
- Posicionamento e mercado: [[IFC/Empreendedorismo/Marketing]] → [[IFC/Empreendedorismo/Mercado]]
- Estratégia de conteúdo e alcance: [[Codigo10k/modulo 02/Inconsciente coletivo e analise de concorrência]] → [[Codigo10k/Modulo 03/Analisando métricas]] → [[Codigo10k/Modulo 03/Dominando a viralização]]
- Finanças e acompanhamento: [[Moody/Financy]]

## 4. Matemática, estatística e análise

- Fundamentos lógicos: [[Faculdade/matematica discreta/Conjuntos]] → [[Faculdade/matematica discreta/grafos]]
- Medidas e tomada de decisão: [[Faculdade/Estatistica/estatistica]] → [[Codigo10k/Modulo 03/Analisando métricas]] → [[IFC/Empreendedorismo/Marketing]]

## 5. Ciência e conhecimento interdisciplinar

- Física e eletricidade: [[IFC/Física/Elétroestatica/Campo elétrico]] → [[IFC/Física/Elétroestatica/Potencial elétrico]]
- Química orgânica: [[IFC/Química/Química organica]] → [[IFC/Química/Funções orgânicas]] → [[IFC/Química/Reações orgânicas]]
- Genética: [[IFC/Genética/1° Lei de mendel]] → [[IFC/Genética/Segunda lei de mendel]] → [[IFC/Genética/Sistema ABO]]
